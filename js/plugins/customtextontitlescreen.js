 ...
 * 
 * CHANGE LOG:
 * 2019-08-10 - Modified by edisonlee55
 * 2015-11-06-0008 - Released.
 * 
 * 
 * @plugindesc (Modified by edisonlee55) Ver.2019-08-10. Displays a custom text on title screen.
 * <Ellye Title Text>
 ...
 * 
 * @param line_spacing
 * @desc Line spacing for the text.
 * @default 4
 * 
 * @param X Offset
...
(function() {
    ...
    //Modified by edisonlee55
    var line_spacing = Number(parameters['line_spacing'] || 4);
    ...
    Scene_Title.prototype.DisplayCustomText = function()
    {
        ...
        for(var i = textLen-1; i >= 0 ; i--) {
            this._titleCustomText.bitmap.drawText(textArr[i], x_offset, yFixFont, maxWidth, font_size, HorizontalAlignment());
            yFixFont -= font_size + line_spacing;
        }
    };
